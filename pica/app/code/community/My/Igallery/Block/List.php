...
class My_Igallery_Block_List extends Mage_Core_Block_Template {
    ...
    public function getGalleries(){
    	if(is_null($this->_galleryCollection)){
    		$this->_galleryCollection = Mage::getResourceModel('igallery/banner_collection')->addEnableFilter();
    	}
    	return $this->_galleryCollection;
    }
