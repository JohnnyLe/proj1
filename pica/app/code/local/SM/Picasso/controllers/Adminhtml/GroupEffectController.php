...
class SM_Picasso_Adminhtml_GroupEffectController extends Mage_Adminhtml_Controller_Action {
    ...
    public function indexAction() {
        $this->_title($this->__('Group Manager'));
        $this->_initAction();
        $this->_addContent($this->getLayout()->createBlock('picasso/adminhtml_group'));
        $this->renderLayout();
    }
    ...
    public function editAction() {
        ...
        $_model  = Mage::getModel('picasso/group')->load($groupId);
            ...
            $this->_addContent($this->getLayout()->createBlock('picasso/adminhtml_group_edit'))
                    ->_addLeft($this->getLayout()->createBlock('picasso/adminhtml_group_edit_tabs'));
    ...
    public function saveAction() {
        ...
        if ($data = $this->getRequest()->getPost()) {
            $_model = Mage::getModel('picasso/group');
    ...
    public function deleteAction() {
        if( $this->getRequest()->getParam('id') > 0 ) {
            try {
                $model = Mage::getModel('picasso/group');
    ...
    public function massStatusAction() {
        ...
        if(!is_array($IDList)) {
            ...
            try {
                foreach ($IDList as $itemId) {
                    $_model = Mage::getSingleton('picasso/group')
