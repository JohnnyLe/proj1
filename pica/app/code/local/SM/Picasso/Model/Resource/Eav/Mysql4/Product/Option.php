 ...
 */
class SM_Picasso_Model_Resource_Eav_Mysql4_Product_Option extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Option
{
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        $descriptionTable = $this->getTable('picasso/product_option_description');
    ...
    public function duplicate(Mage_Catalog_Model_Product_Option $object, $oldProductId, $newProductId)
    {
        ...
        foreach ($optionsCond as $oldOptionId => $newOptionId) {
            ...
            // description
            $table = $this->getTable('picasso/product_option_description');
            $sql = 'REPLACE INTO `' . $table . '` '
