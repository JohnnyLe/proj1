...
class SM_Picasso_Model_Resource_Eav_Mysql4_Product_Option_Collection extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Option_Collection
{
    public function getOptions($store_id)
    {
        $this->getSelect()
            ...
            ->joinLeft(array('default_option_description'=>$this->getTable('picasso/product_option_description')),
            ...
            ->joinLeft(array('store_option_description'=>$this->getTable('picasso/product_option_description')),
