      ...
      var _handler = {
        onUploaderComplete : function(e,id,fileName,responseJson,selected) {
            ...
            if(typeof(selected) == 'boolean'){
                if(selected){
                    _uploadList[id] = {'filename':fileName,'responseJson':responseJson,'selected':true};
                    ...
                    $('a.share-link-button').each(function(){
                        ...
                        var link = linkTemplate.replace('{ADDRESS}', encodeURIComponent(_uploadList[id].currentImageUrl))
                            .replace('{BLOGURL}', encodeURIComponent(window.location.href))
                            .replace('{IMAGE}',encodeURIComponent(_uploadList[id].currentImageUrl));
                        $(this).attr('href',link);
                    });
                }
                else{
                    _uploadList[id] = {'filename':fileName,'responseJson':responseJson,'selected':false};
                }
            }
            else{
                _uploadList[id] = {'filename':fileName,'responseJson':responseJson,'selected':true};
      	...
      	updateEditor : function(id,fileName,responseJson,isProcessThumb){
        	...
        	$('a.share-link-button').each(function(){
				var linkTemplate = $(this).attr('link_template');
				var link = linkTemplate.replace('{ADDRESS}', encodeURIComponent(responseJson.imageUrl))
                                        .replace('{BLOGURL}', encodeURIComponent(window.location.href))
										.replace('{IMAGE}',encodeURIComponent(responseJson.imageUrl));
				$(this).attr('href',link);
			});
      	...
      	reloadEffect:function(){
      		...
      		if(effect !='' && _currentImagePath !=''){
	        		...
	        		$.ajax({
		            		...
		            		type:'POST',
		            		data: {'image_path':_currentImagePath,'effect_id':effect,'crop':crop,'brightness_contrast':brightnessContrast},
		            		dataType: 'json',
		            		async:true,
		            		success:function(data) {
		            			...
		            			$('a.share-link-button').each(function(){
		            				var linkTemplate = $(this).attr('link_template');
		            				var link = linkTemplate.replace('{ADDRESS}', encodeURIComponent(data.src))
                                                            .replace('{BLOGURL}', encodeURIComponent(window.location.href))
		            										.replace('{IMAGE}',encodeURIComponent(data.src));
		            				$(this).attr('href',link);
		            			});
        ...
        syncUI : function() {
        	...
        	$(".selectable").children("li").click(function(e){
                ...
                if(typeof(settings.effects[effect]) != 'undefined'){
                    ...
                    optionsPrice.addCustomPrices('image_effect', {excludeTax:effectPrice,includeTax:effectPrice,oldPrice:effectPrice,price:effectPrice,priceValue:effectPrice,type:"fixed"});
                    optionsPrice.reload();
                }
        		...
        		if(typeof(imageSelected.data('imgLoad')) == 'undefined' || imageSelected.data('imgLoad') == null || imageSelected.data('imgLoad') == ''){
                    ...
                    $('a.share-link-button').each(function(){
                        var linkTemplate = $(this).attr('link_template');
                        var link = linkTemplate.replace('{ADDRESS}', encodeURIComponent(imageSelected.data('imgLoad')))
                            .replace('{BLOGURL}', encodeURIComponent(window.location.href))
                            .replace('{IMAGE}',encodeURIComponent(imageSelected.data('imgLoad')));
                        $(this).attr('href',link);
                    });
        	...
        	if(typeof(settings.currentImageEdit) != 'undefined' && settings.currentImageEdit.orgImageSrc !=''){
                ...
                if(typeof(settings.currentImageEdit.fileImageSelected) !='undefined'){
                    ...
                    $('a.share-link-button').each(function(){
                        var linkTemplate = $(this).attr('link_template');
                        var link = linkTemplate.replace('{ADDRESS}', encodeURIComponent(settings.currentImageEdit.fileImageSelected))
                            .replace('{BLOGURL}', encodeURIComponent(window.location.href))
                            .replace('{IMAGE}',encodeURIComponent(settings.currentImageEdit.fileImageSelected));
                        $(this).attr('href',link);
                    });
                }
