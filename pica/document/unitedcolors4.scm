;SMARTOSC - TUANNA
;File: unitedcolors4.scm
;Function: smartosc-unitedcolors4
;param

(define (smartosc-unitedcolors4
    ...
    (define newLayer)
    (gimp-palette-set-background '(36 78 39))
    ...
    (plug-in-colorify RUN-NONINTERACTIVE img inLayer '(244 165 234))
...
(script-fu-register
                    "smartosc-unitedcolors4"                  ;function name
                    _"United Colors Effect 4"                   ;menu label
                    "United Colors Effect 4"                    ;description
...
;register
(script-fu-menu-register "smartosc-unitedcolors4" _"<Image>/SmartOSC")