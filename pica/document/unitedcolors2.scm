;SMARTOSC - TUANNA
;File: unitedcolors2.scm
;Function: smartosc-unitedcolors2
;param

(define (smartosc-unitedcolors2
    ...
    (define newLayer)
    (gimp-palette-set-background '(233 241 13))
    ...
    (plug-in-colorify RUN-NONINTERACTIVE img inLayer '(28 91 207))
...
(script-fu-register
                    "smartosc-unitedcolors2"                  ;function name
                    _"United Colors Effect 2"                   ;menu label
                    "United Colors Effect 1"                    ;description
...
;register
(script-fu-menu-register "smartosc-unitedcolors2" _"<Image>/SmartOSC")